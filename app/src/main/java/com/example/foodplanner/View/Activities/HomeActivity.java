...
import com.example.foodplanner.Model.NetworkChangeReceiver;
import com.example.foodplanner.Model.NetworkUtil;
import com.example.foodplanner.Model.OnMealsLoadedListener;
                        ...
                        if(NetworkUtil.isNetworkConnected(HomeActivity.this))
                        {
                            ...
                            mealDao.getAllMeals().observe(HomeActivity.this, meals -> {
                                if (meals != null) {
                                    ...
                                    // Save the list of meals to Firestore
                         ...
                         // Finish HomeActivity if you don't want the user to return to it
